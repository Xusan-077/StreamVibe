    ...
    <section className="">
      <div className="bg-[#0F0F0F] h-screen flex flex-col duration-200">
        <div className="border-b border-[#262626]">
          <div className="mx-auto px-6 py-6 flex items-center gap-6">
            <Link href="/">
              <Image
                src={images.logo}
                alt="StreamVibe Logo"
            ...
            <div className="flex-1 relative group flex items-center">
              ...
              >
                <input
                  ...
                  className="w-full bg-[#141414] border border-[#262626] rounded-xl py-4 pl-14 pr-6 text-white text-xl outline-none focus:border-[#E50000] transition-all"
                />
                <button
                  type="submit"
                  disabled={isPending}
                  className="relative flex items-center justify-center gap-2 bg-[#E50000] hover:bg-[#ff1a1a] disabled:bg-[#4d0000] disabled:cursor-not-allowed text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 active:scale-95 shadow-lg shadow-[#E50000]/20 overflow-hidden"
                >
                  {isPending ? (
            ...
            <button
              onClick={() => router.back()}
              className="flex items-center gap-2 text-zinc-400 hover:text-white transition-all bg-[#1A1A1A] px-5 py-4 rounded-xl border border-[#262626]"
            >
