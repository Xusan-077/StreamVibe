        ...
        <div className="mb-37.5">
          ...
          <ul className="grid grid-cols-3 gap-7.5">
            {MovieTypes.map((el, index) => (
              <li
                key={index}
                className="bg-[linear-gradient(220deg,_rgba(229,0,0,0.05)_0%,_rgba(15,15,15,1)_20%)] border border-[#333333] rounded-lg p-12.5"
              >
                <div className="">
                  <div className="flex items-center gap-4 mb-7.5">
                    <div className="w-18 h-18 flex items-center justify-center rounded-lg bg-[#141414]">
